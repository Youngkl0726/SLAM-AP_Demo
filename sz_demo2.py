...
def get_slam_info(filename):
    slam = open(filename)
    slam_3d_pos = [[] for i in range(400)]
    slam_pic_pos = [[] for i in range(400)]
    slam_num = -1
    for i in range(13088):
...
def main():
    ...
    point_pos_file = r'./sz_time/sz_time_out2.txt'
